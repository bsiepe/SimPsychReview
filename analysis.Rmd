...
sim_res_num <- readRDS(file = "data/sim_res_num.RDS")

# subset assessment only
sim_res_fac  <- sim_res_fac[sim_res_fac$simstudy_q1 == "yes",]
sim_res_num  <- sim_res_num[sim_res_num$simstudy_q1 == "yes",]

sim_res_fac  <- data.frame(sim_res_fac[sim_res_fac$coding_type == "assessment",])
sim_res_num  <- data.frame(sim_res_num[sim_res_num$coding_type == "assessment",])
